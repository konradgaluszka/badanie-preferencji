...
export class Questionnaire extends Component {
    ...
    render() {
        const { addQuestionnaireAnswer, goToNextStep, errors, questionnaire } = this.props;
        ...
        return (
            <Row className="show-grid well center">
                <Col md={5}>
                    {
                        errors.questionnaire && <div className="alert alert-danger text-center">
                                                        ...
                                                        [1, 2, 3, 4]
                                                            .map(number =>
                                                                <span
                                                                    ...
                                                                    onClick={() => addQuestionnaireAnswer(question.id, number, 'questionnaire')}
                                                                >
                                                                    {number}
                                                                </span>)
                                                    }
                    ...
                    <Button
                        ...
                        bsStyle="primary"
                        bsSize="large"
                        onClick={() => goToNextStep('questionnaire', numberOfAllQuestions === numberofAllAnswers)}>
                        Dalej
                    </Button>
                </Col>
            </Row>
